...
[Version control](learners/reference.md#version-control) has many benefits:
...
In this lesson we use Git from the Unix Shell. We'll cover aspects of the Unix
Shell necessary for using Git.
